...
clear
echo -e "$green VPS Type             :$CYAN $typevps"$NC
...
echo -e "$green Username             :$CYAN $username $NC"
echo -e "$green Client Name          :$CYAN $name${NC}"
echo -e "$green Expired On           :$CYAN $exp"$NC
echo -e "$green Expired In           :$CYAN $remain Days"$NC
