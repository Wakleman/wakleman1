...
echo "Stunnel 4            : $(cat /etc/stunnel/stunnel.conf | grep -i accept | head -n 2 | cut -d= -f2 | sed 's/ //g' | tr '\n' ' ' | awk '{print $1}') , $(cat /etc/stunnel/stunnel.conf | grep -i accept | head -n 2 | cut -d= -f2 | sed 's/ //g' | tr '\n' ' ' | awk '{print $2}')" | tee -a log-install.txt
...
echo "" | tee -a log-install.txt
echo "V2Ray VMess TLS      : $(cat /etc/v2ray/config.json | grep -w port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "V2Ray VMess Non TLS  : $(cat /etc/v2ray/none.json | grep -w port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "V2Ray VLess TLS      : $(cat /etc/v2ray/vless.json | grep -w port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "V2Ray VLess Non TLS  : $(cat /etc/v2ray/vnone.json | grep -w port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "V2Ray Trojan TCP     : $(cat /etc/trojan/config.json | grep -w local_port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "" | tee -a log-install.txt
echo "XRay Core > > >" | tee -a log-install.txt
echo "" | tee -a log-install.txt
echo "XRay VMess TLS       : $(cat /etc/xray/vmesstls.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay VMess Non TLS   : $(cat /etc/xray/vmessnone.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay VLess TLS       : $(cat /etc/xray/vlesstls.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay VLess Non TLS   : $(cat /etc/xray/vlessnone.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay VLess XTLS      : $(cat /etc/xray/xrayxtls.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay Trojan          : $(cat /etc/xray/trojan.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay VMess GRPC TLS  : $(cat /etc/xray/vmessgrpc.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay VLess GRPC TLS  : $(cat /etc/xray/vlessgrpc.json | grep port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
echo "XRay TRojan GRPC     : $(cat /etc/xray/trojangrpc.json | grep -w port | awk '{print $2}' | sed 's/,//g')" | tee -a log-install.txt
